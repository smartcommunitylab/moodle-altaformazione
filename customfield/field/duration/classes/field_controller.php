...
class field_controller extends \core_customfield\field_controller {
    ...
    /**
     * Add fields for editing a duration field.
     *
    ...
    public function config_form_definition(\MoodleQuickForm $mform) {
        ...
        $options = array(HOURSECS => "hours", MINSECS => "mins");
        $mform->addElement('select', "configdata[units]", get_string('units', 'customfield_duration'), $options);
