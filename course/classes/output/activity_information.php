...
class activity_information implements renderable, templatable {
	...
	$data->weight = $this->get_activity_weight($data->cmid);
    ...
    public function get_activity_weight($cmid){
        global $DB;
        $hours = 0;
        $mins = 0;
	...
	$data->viewed = (int)$this->cmcompletion->get_details()["completionview"]->status == 1;
