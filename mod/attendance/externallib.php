...
class mod_attendance_external extends external_api {
    ...
    public static function add_attendance_parameters() {
        return new external_function_parameters(
            array(
                ...
                'name' => new external_value(PARAM_RAW, 'attendance name'),
                'sectionid' => new external_value(PARAM_INT, 'course section'),
     ...
     * @return array
     */
    public static function add_attendance(int $courseid, $name, $sectionid, $intro, int $groupmode) {
        global $CFG, $DB;
