 ...
 */
function quiz_create_attempt(quiz $quizobj, $attemptnumber, $lastattempt, $timenow, $ispreview = false, $userid = null, $time_end=null) {
    global $USER;
    ...
    $attempt->timefinish = $time_end ? $time_end !=null : 0;
...
function quiz_start_new_attempt($quizobj, $quba, $attempt, $attemptnumber, $timenow,
    ...
    if ($randomfound) {
        ...
        foreach ($quizobj->get_questions() as $questiondata) {
            ...
            if (isset($questionids[$slot])) {
                //if ($randomloader->is_question_available($questiondata->category, (bool) $questiondata->questiontext, $questionids[$slot], $tagids)) {
                if(true){
                    $questions[$slot] = question_bank::load_question(
                            $questionids[$slot], $quizobj->get_quiz()->shuffleanswers);
                    continue;
                } else {
...
function quiz_prepare_and_start_new_attempt(quiz $quizobj, $attemptnumber, $lastattempt,
        $offlineattempt = false, $forcedrandomquestions = [], $forcedvariants = [], $userid = null, $time_start=null, $time_end=null) {
    global $DB, $USER;
    ...
    $attempt = quiz_create_attempt($quizobj, $attemptnumber, $lastattempt, $timenow, $ispreviewuser, $userid, $time_end);
